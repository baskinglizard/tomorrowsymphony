...
A website that connects students of classical music with teachers in the philadelphia area
...
To run the tests, enter the tomorrowsymphony_project/tests directory and run the following commands::
